...
import {hp, wp} from './src/helpers/Responsiveness';
import ResponsiveText from './src/components/RnText';
import {colors} from './src/constants/colorsPallet';
import CustomAxisPad from './src/components/CustomAxisPad';
import LeftJoystick from './src/components/LeftJoystick';
import RightJoystick from './src/components/RightJoystick';
import CustomSlider from './src/components/Slider';
import {globalPath} from './src/constants/globalPath';
import Icon from './src/components/Icon';
import RightIcons from './src/components/RightIcons';
